...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Metadata_Audit</application>
        <default>true</default>
        <visible>true</visible>
    </applicationVisibilities>
    <classAccesses>
        <apexClass>MetadataAuditJobLogSelector</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MetadataAuditLogItemsSelector</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MetadataAuditLogQueueable</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>MetadataAuditLogService</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        ...
        <field>Metadata_Audit_Configuration__mdt.Enabled__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Job_Log__c.Execution_Log__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Log_Item__c.Delete_Discovered_Date__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Log_Item__c.Entry_type__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Log_Item__c.Filename__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Log_Item__c.Metadata_LM_By__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Log_Item__c.Metadata_LM_Date__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Log_Item__c.Type__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Run_Log__c.Items_added__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Run_Log__c.Items_deleted__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Run_Log__c.Items_modified__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Run_Log__c.Metadata_category__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Metadata_Audit_Run_Log__c.Number_of_query_items_returned__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>Metadata_Audit_Configuration__mdt-Metadata Audit Configuration Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Metadata_Audit_Job_Log__c-Metadata Audit Job Log Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Metadata_Audit_Log_Item__c-Metadata Audit Log Item Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Metadata_Audit_Run_Log__c-Metadata Audit Run Log Layout</layout>
    </layoutAssignments>
    <objectPermissions>
        ...
        <object>Metadata_Audit_Job_Log__c</object>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Metadata_Audit_Log_Item__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>true</allowCreate>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Metadata_Audit_Run_Log__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <tabVisibilities>
